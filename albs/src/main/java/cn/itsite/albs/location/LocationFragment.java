...
public class LocationFragment extends BaseFragment implements
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        tvKeword = (TextView) view.findViewById(R.id.keyWord);
        tvSearch = (TextView) view.findViewById(R.id.bt_search);
        recyclerView = (RecyclerView) view.findViewById(R.id.recyclerView);
        myLocation = (ImageView) view.findViewById(R.id.iv_location_fragment);
        ivBack = (ImageView) view.findViewById(R.id.iv_back_location_fragment);
        cvSearch = (CardView) view.findViewById(R.id.cv_search_location_fragment);
        tvLocation = (TextView) view.findViewById(R.id.tv_location_fragment);
    ...
    private void initView() {
        ...
        ivBack.setOnClickListener(v -> ((SupportActivity) _mActivity).onBackPressedSupport());
