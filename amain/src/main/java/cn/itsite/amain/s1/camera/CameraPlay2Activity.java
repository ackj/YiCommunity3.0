...
import cn.itsite.amain.s1.utils.CameraHelper;

public class CameraPlay2Activity extends BaseMonitorActivity implements CameraSettingContract.View, View.OnClickListener {
    public static final String TAG = CameraPlay2Activity.class.getSimpleName();
    ...
    private void initView() {
        ...
        viewRECPointer = ((View) findViewById(R.id.view_red_pointer));
        ...
        ivPhotograph = ((ImageView) findViewById(R.id.iv_photograph));
