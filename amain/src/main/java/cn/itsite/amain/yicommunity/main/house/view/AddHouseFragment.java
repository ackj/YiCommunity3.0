 ...
 * 负责房屋模块的View层内容。
 */
public class AddHouseFragment extends BaseFragment<AddHouseContract.Presenter>
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if (bundle != null) {
            title = bundle.getString(Constants.KEY_ADDRESS);
        }
    }
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        tvProprietor = ((TextView) view.findViewById(R.id.tv_proprietor_house_fragment));
        tvTenant = ((TextView) view.findViewById(R.id.tv_tenant_house_fragment));
        tvRelative = ((TextView) view.findViewById(R.id.tv_relative_house_fragment));
        etName = ((EditText) view.findViewById(R.id.et_name_house_fragment));
        etIdcard = ((EditText) view.findViewById(R.id.et_idcard_house_fragment));
        llArea = ((LinearLayout) view.findViewById(R.id.ll_area_add_house_fragment));
        llCommunity = ((LinearLayout) view.findViewById(R.id.ll_community_add_house_fragment));
        btSubmit = ((Button) view.findViewById(R.id.bt_submit_house_fragment));
        llBuilding = ((LinearLayout) view.findViewById(R.id.ll_building_add_house_fragment));
        llUnit = ((LinearLayout) view.findViewById(R.id.ll_unit_add_house_fragment));
        llFloor = ((LinearLayout) view.findViewById(R.id.ll_floor_add_house_fragment));
        llRoom = ((LinearLayout) view.findViewById(R.id.ll_room_add_house_fragment));
        tvArea = ((TextView) view.findViewById(R.id.tv_area_add_house_fragment));
        tvCommunity = ((TextView) view.findViewById(R.id.tv_community_add_house_fragment));
        tvBuilding = ((TextView) view.findViewById(R.id.tv_building_add_house_fragment));
        tvUnit = ((TextView) view.findViewById(R.id.tv_unit_add_house_fragment));
        tvFloor = ((TextView) view.findViewById(R.id.tv_floor_add_house_fragment));
        tvRoom = ((TextView) view.findViewById(R.id.tv_room_add_house_fragment));
        llCardContainer = ((LinearLayout) view.findViewById(R.id.ll_card_container));
        return view;
    }
    ...
    private void initListener() {
        ...
        tvProprietor.setOnClickListener(this);
        ...
        llBuilding.setOnClickListener(this);
        llUnit.setOnClickListener(this);
        llFloor.setOnClickListener(this);
    ...
    public void onClick(View v) {
        int i = v.getId();
        if (i == R.id.tv_card_type) {
            new AlertDialog.Builder(_mActivity)
                    .setItems(idType, (dialog, which) -> {
                        params.certificateType = (which + 1) + "";
                        tvCardType.setText(idType[which]);
                    }).show();

        } else if (i == R.id.tv_proprietor_house_fragment) {
            isEdited = false;//标记曾经选择过。
            resetIdentity(1);//当点击时，刷新背景。

        } else if (i == R.id.tv_relative_house_fragment) {
            isEdited = true;
            resetIdentity(2);//当点击时，刷新背景。

        } else if (i == R.id.tv_tenant_house_fragment) {
            isEdited = true;//标记曾经选择过。
            resetIdentity(3);//当点击时，刷新背景。

        } else if (i == R.id.ll_area_add_house_fragment) {
            showAddressSelector();//选择省市县。

        } else if (i == R.id.ll_community_add_house_fragment) {
        ...
        } else if (i == R.id.ll_building_add_house_fragment) {
        ...
        } else if (i == R.id.ll_unit_add_house_fragment) {
        ...
        } else if (i == R.id.ll_floor_add_house_fragment) {
        ...
        } else if (i == R.id.ll_room_add_house_fragment) {
        ...
        } else if (i == R.id.bt_submit_house_fragment) {
