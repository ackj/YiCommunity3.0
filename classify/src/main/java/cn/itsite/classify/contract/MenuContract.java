...
public interface MenuContract {
    ...
    interface Presenter extends BaseContract.Presenter {
        void getGategories(GoodsParams params);

        void getProducts(GoodsParams params);
    }

    interface Model extends BaseContract.Model {
        Observable<BaseResponse<List<MenuBean>>> getGategories(GoodsParams params);

        Observable<BaseResponse<List<ProductBean>>> getProducts(GoodsParams params);
    }
}
