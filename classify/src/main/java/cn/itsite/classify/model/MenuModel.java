...
public class MenuModel extends BaseModel implements MenuContract.Model {
    ...
    @Override
    public Observable<BaseResponse<List<MenuBean>>> getGategories(GoodsParams params) {
    ...
    @Override
    public Observable<BaseResponse<List<ProductBean>>> getProducts(GoodsParams params) {
        return HttpHelper.getService(MenuService.class)
